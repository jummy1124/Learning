...
def detect(save_img=False):
    global xyxy,im0,label,colors,cls,p,conf
            ...
            if det is not None and len(det):
                ...
                for *xyxy, conf, cls in det:
                    ...
                    if save_img or view_img:  # Add bbox to image
                        ...
                        im0 = cv2.resize(im0, None, fx=1., fy=1., interpolation=cv2.INTER_AREA)
                        cv2.imshow(p, im0)
                        cv2.setMouseCallback(p, mouse_select)
